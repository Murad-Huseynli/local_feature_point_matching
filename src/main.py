...
def main():
    ...
    # Testing purposes
    # print("First ND of the pair " + str(len(x1)))
    # print("Second ND of the pair " + str(len(x2)))
    ...
    # Testing purposes
    # print("First MR of the pair " + str(len(x1)))
    # print("Second MR of the pair " + str(len(x2)))
    ...
    # Testing purposes
    # print("First EG of the pair " + str(len(x1)))
    # print("Second EG of the pair " + str(len(x2)))
